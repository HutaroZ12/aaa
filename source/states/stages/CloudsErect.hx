...
class Clouds extends BaseStage
{
    ...
    {       
        layer0 = new BGSprite('stages/sky/erect/layer0', -500, -300);
        layer0.scrollFactor.set(1, 1);
        add(layer0);

        // Camada 1
        layer1 = new BGSprite('stages/sky/erect/layer1', -500, -300);
        layer1.scrollFactor.set(0.85, 0.85);
        add(layer1);

        // Segunda instância da camada 1
        layer1b = new BGSprite('stages/sky/erect/layer1', layer1.x + layer1.width, layer1.y);
        layer1b.scrollFactor.set(0.85, 0.85);
        add(layer1b);

        // Camada 2
        layer2 = new BGSprite('stages/sky/erect/layer2', -500, -300);
        layer2.scrollFactor.set(0.9, 0.9);
        add(layer2);

        // Segunda instância da camada 2
        layer2b = new BGSprite('stages/sky/erect/layer2', layer2.x + layer2.width, layer2.y);
        layer2b.scrollFactor.set(0.9, 0.9);
        add(layer2b);

        layer3 = new BGSprite('stages/sky/erect/layer3', -500, -300, 1, 1);
        add(layer3);
    ...
    {
        layer5 = new BGSprite('stages/sky/erect/layer5', -500, -300);
