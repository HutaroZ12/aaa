...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'sky': new Clouds();                        //WeekEyz
		        case 'skyerect': new CloudsErect();                        //WeekEyz
		...
		healthBarBG = new FlxSprite(30, FlxG.height - 75).loadGraphic(Paths.image('healthBarBG'));
		...
		if(ClientPrefs.data.downScroll) healthBarBG.y = 58;
		...
		if(ClientPrefs.data.downScroll) healthBar.y = 60;
		reloadHealthBarColors();
		
		iconP1 = new HealthIcon(boyfriend.healthIcon, true);
		iconP1.y = healthBar.y - 73;
